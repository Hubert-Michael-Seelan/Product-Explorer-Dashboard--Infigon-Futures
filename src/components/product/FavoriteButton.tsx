...
export default function FavoriteButton({ productId }: { productId: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M12 21s-6.716-4.686-9.364-7.333C.988 11.02 1.19 6.92 4.3 5.3c2.02-1.06 4.44-.37 5.7 1.33 1.26-1.7 3.68-2.39 5.7-1.33 3.11 1.62 3.31 5.72 1.66 8.37C18.716 16.314 12 21 12 21z"
        />
      </svg>
    </button>
  );
